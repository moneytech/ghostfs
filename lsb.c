...
static int lsb_read(struct stegger *self, void *buf, size_t size, size_t offset)
{ 
...
static int lsb_write(struct stegger *self, const void *buf, size_t size, size_t offset)
{
	struct lsb *lsb = container_of(self, struct lsb, stegger);
	int wbit, rbit = 0;
